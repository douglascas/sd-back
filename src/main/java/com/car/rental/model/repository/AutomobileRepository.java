...
public interface AutomobileRepository extends JpaRepository<Automobile, Long>, JpaSpecificationExecutor<Automobile> {
    ...
    Automobile findFirstByManufacturerIdAndModelYearFipeIdAndModelYearYearAndCategoryId(Integer ManufacturerId, String modelYearFipeId, String ModelYearYear, Integer categoryId);
}
